...
ActiveRecord::Schema[7.0].define(version: 2023_09_08_072935) do
  ...
  create_table "shippng_addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["purchase_id"], name: "index_shippng_addresses_on_purchase_id"
  end
  ...
  add_foreign_key "shippng_addresses", "purchases"
end
